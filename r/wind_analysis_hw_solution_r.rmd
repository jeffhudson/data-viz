...
# convert modified date_time character string to POSIX
...
Save the augmented data.frame `dat`. This reflects the full dataset after NA checks and benchmark calculations, but prior to applying filters.
```{r save}
